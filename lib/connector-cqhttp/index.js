...
module.exports = class CQHttpConnector {
   ...
   */
  onMsgReceived(msg, resp) {
    if (msg.post_type === 'message') {
      if (msg.message_type === 'group') {
        this.cqnode.emit(receivedMsgTypeMap.GROUP, { msg: type.groupMessage(msg), resp });
      } else if (msg.message_type === '')
      const reply = this.cqnode.emit(receivedMsgTypeMap[msg.message_type], msg);
      return resp.end();
    }
